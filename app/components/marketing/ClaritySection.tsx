      ...
      <div className="container">
        ...
        <div className="grid grid-cols-12 gap-6 md:gap-8">
          ...
          <FeatureCard
            ...
            chips={['Saved in your browser', 'No contact information collected']}
            cta={{ href: '/privacy', label: 'Learn more' }}
            icon={<ShieldCheck className="h-5 w-5 stroke-[1.75]" />}
          >
            Start privately. We avoid collecting contact information and do not send your answers
            to trial sites. Use PatientMatch to understand public trial options and prepare questions.
          </FeatureCard>
        </div>
      </div>
    </section>
