          ...
          <div className="rounded-2xl border border-pm-border/70 bg-white/80 p-6 shadow-soft backdrop-blur-sm lg:col-span-2">
            <div className="sm:flex sm:items-start sm:justify-between">
              <div className="max-w-2xl">
                ...
                <p className="mt-2 text-sm md:text-base text-pm-body">
                  Start privately. Share details with a site only after you&apos;re comfortable. Our
                  HIPAA-aware workflow uses explicit consent gating and clear next steps.
                </p>
                <div className="mt-4 flex flex-wrap gap-2">
                  <StatChip>HIPAA-aware process</StatChip>
                  <StatChip>Explicit consent before sharing</StatChip>
                </div>
                <div className="mt-4">
