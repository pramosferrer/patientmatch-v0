...
const steps = [
  {
    ...
    body: "We ask a few clinical questions in everyday language—no jargon.",
  },
  {
    icon: <Workflow className="h-5 w-5 text-pm-muted" />,
    title: "We pre-screen against criteria",
    body: "Inclusion/exclusion rules applied automatically—no guesswork.",
  },
  {
    icon: <CheckCircle2 className="h-5 w-5 text-pm-muted" />,
    title: "See likely matches immediately",
    body: "Ranked results, with clear reasons and next steps.",
  },
];
