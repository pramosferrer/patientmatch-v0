        ...
        <form className="mt-6 space-y-6" onSubmit={(e) => e.preventDefault()}>
          ...
          <div>
            ...
            <select
              ...
              className="mt-2 h-32 w-full rounded-xl border border-border bg-warm-cream/70 px-3 py-2 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2"
            >
              {conditionOptions.map((option) => (
