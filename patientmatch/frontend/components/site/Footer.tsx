      ...
      <div className="container mx-auto px-4 md:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="md:col-span-2">
            ...
            <p className="text-pm-body mb-4 max-w-md">
              Helping patients find relevant clinical trials through intelligent matching and 
              streamlined screening processes.
            </p>
            <div className="flex items-center gap-4 text-sm text-pm-muted">
              <div className="flex items-center gap-2">
                <Mail size={16} />
                <a href="mailto:hello@patientmatch.com" className="hover:text-pm-secondary transition-colors">
                  hello@patientmatch.com
                </a>
              </div>
            </div>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link className="hover:text-foreground focus-visible:outline focus-visible:outline-2 focus-visible:outline-pm-secondary rounded" href="/contact">Contact</Link>
              </li>
              <li>
        ...
        <div className="border-t border-pm-border/60 mt-8 pt-8 flex flex-col md:flex-row items-center justify-between gap-4">
          <p className="text-sm text-pm-muted">
            © 2024 PatientMatch. All rights reserved.
          </p>
