...
import { MessageSquare, ListChecks, Sparkles, Building2, ChevronLeft, ChevronRight } from "lucide-react";
...
const steps: ProcessStep[] = [
  ...
  {
    id: "step-4",
    title: "Connect with a research site",
    description: "If you choose to proceed, we connect you with the research team at your preferred location.",
          ...
          <div className="flex items-center justify-between pt-4 border-t border-pm-border/30">
            ...
            <div className="flex items-center gap-3">
              ...
              {activeStep === steps.length - 1 ? (
                // Final step - show CTA
                <Link
                  href={currentStep.cta?.href || "/match"}
