...
export default function PatientForm() {
  ...
  const [finalStatus, setFinalStatus] = useState(null); // 'success' or 'fail'
          ...
          <div className="space-y-6">
            <div className="space-y-2">
              ...
              {q.type === 'number' ? (
                ...
                <Select value={formData[q.name]} onValueChange={(value) => handleChange(q.name, value)}>
                  <SelectTrigger>
            ...
            <div className="space-y-4">
              ...
              <div className="flex items-start space-x-2">
                ...
                <Label htmlFor="privacy-consent" className="text-sm leading-relaxed">
                  ...
                  {' '}and consent to having my information stored and shared with the clinical trial site for the purpose of being contacted about this study.
                </Label>
              </div>
            </div>
          </div>
