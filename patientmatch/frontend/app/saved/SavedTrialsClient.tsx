...
export default function SavedTrialsClient() {
    ...
    if (savedTrials.length === 0) {
        return (
            <div className="flex flex-col items-center justify-center py-24 text-center">
                ...
                <h2 className="mb-2 text-2xl font-semibold text-pm-ink">No saved trials yet</h2>
                <p className="mb-8 max-w-md text-pm-muted">
                    Browse trials and tap the bookmark icon to save them here for later review or comparison.
                </p>
                <div className="flex gap-4">
                    <Button asChild>
                        <Link href="/trials">Browse all trials</Link>
                    </Button>
    ...
    return (
        <div className="mx-auto w-full max-w-4xl">
            ...
            <div className="mb-8">
                <h1 className="text-3xl font-semibold text-pm-ink">Saved Trials</h1>
                <p className="mt-2 text-pm-muted">
                    You have saved {savedTrials.length} trial{savedTrials.length === 1 ? '' : 's'}.
                </p>
            </div>
