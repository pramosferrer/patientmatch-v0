...
trials
- nct_id (PK), title, display_title, sponsor, phase, status, status_bucket, gender
...
- top_disqualifiers_json, insights_flags_json, plain_summary_json (patient-facing summary payload)
