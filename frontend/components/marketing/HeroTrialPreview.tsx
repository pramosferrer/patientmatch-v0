...
function TrialCard({ item }: { item: HeroSample }) {
  ...
  return (
    <div className="relative flex w-full min-h-[180px] flex-col overflow-hidden rounded-lg border border-hairline text-left shadow-[0_16px_40px_rgba(15,23,42,0.08)] md:min-h-[170px]">
      ...
      <div className="relative z-20 flex flex-1 flex-col gap-4 p-4">
        <div className="flex flex-wrap items-start justify-between gap-3 text-[12px] text-muted-foreground">
          <div className="flex flex-col gap-2">
            <span
              className="relative inline-flex items-center rounded-lg border border-hairline bg-white py-1 pl-4 pr-3 font-medium text-foreground"
              style={{
