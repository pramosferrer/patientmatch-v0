...
const enrichCondition = (simpleCondition: SimpleCondition): Condition => {
...
function ConditionCard({ slug, title, subtitle, common, examples, href }: ConditionCardProps) {
  const colors = getConditionColors(slug);
  return (
    <div className="flex h-full flex-col rounded-lg bg-white p-6 shadow-[0_16px_36px_rgba(15,23,42,0.08)] transition hover:shadow-[0_20px_48px_rgba(15,23,42,0.12)]">
...
export default function Conditions({ conditions: propConditions }: ConditionsProps) {
